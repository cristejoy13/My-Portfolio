...
export const experiences = [
  ...
  },
  {
    ...
    linkType: 'external',
    cta: 'Try the app →',
    description: 'A personal planning web app designed to help users set goals, track habits, and stay organized. Personally built with AI-assisted development, Codex, and VS Code.',
  },
  {
    id: 5,
    company: 'FruGal',
    ...
    linkType: 'external',
    cta: 'Try the app →',
    description: 'A personal finance web app for tracking budgets, expenses, and investments. Personally built with AI-assisted development, Codex, and VS Code.',
  },
  {
    id: 2,
